...
// 5-tile KPI band at the top of /platform/notifications.
//
//   Registered    Published     Drafts       Disabled    Critical
//   12            7             3            1           5
...
const TONE: Record<NonNullable<NotificationsKpi["tone"]>, { bg: string; border: string; label: string }> = {
...
export function NotificationsKPIBand({ kpis }: { kpis: NotificationsKpi[] }) {
  return (
...
function Tile({ kpi }: { kpi: NotificationsKpi }) {
