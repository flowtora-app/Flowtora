...
// 5-tile KPI band at the top of /platform/compliance.
//
//   Open exports   Pending deletions   Completed (30d)   Avg fulfillment   SLA risk
//   3              1                   12                4h 12m            0
...
export interface ComplianceKpi {
  ...
  deltaPct?: number;
  /** Inverts green/red — increases in pending are bad. */
  deltaInvert?: boolean;
  tone?: "default" | "accent" | "success" | "warning" | "danger";
}

const TONE: Record<NonNullable<ComplianceKpi["tone"]>, { bg: string; border: string; label: string }> = {
...
export function ComplianceKPIBand({ kpis }: { kpis: ComplianceKpi[] }) {
  return (
...
function Tile({ kpi }: { kpi: ComplianceKpi }) {
