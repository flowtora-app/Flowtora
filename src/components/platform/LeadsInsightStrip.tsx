...
// Auto-generated alert strip at the top of the leads inbox.
// The page passes a list of insights; this component renders them as
// stacked rows with a tone-keyed icon. Three tones cover what we want
// to surface:
//
//   info     — neutral context ("Top demo source: pricing page")
//   warning  — attention needed ("3 demo requests have sat untouched > 24h")
//   positive — good news        ("Leads up 18% vs prior period")
//
// Generated from real data — never hand-coded copy. See
// `buildLeadInsights()` for the rule list.
...
export function LeadsInsightStrip({ insights }: { insights: LeadInsight[] }) {
