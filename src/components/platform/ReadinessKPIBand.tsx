...
// 6-tile KPI band at the top of /platform/readiness.
//
//   Total   Ready (%)   Blocked   Avg score   New (7d)   Stripe linked %
//   42      67%         14        78%         5 (+2)     85%
...
export interface ReadinessKpi {
  ...
  deltaPct?: number;
  /** Inverts the green/red mapping — increases in blocked are bad. */
  deltaInvert?: boolean;
  tone?: "default" | "accent" | "success" | "warning" | "danger";
}

const TONE: Record<NonNullable<ReadinessKpi["tone"]>, { bg: string; border: string; label: string }> = {
...
export function ReadinessKPIBand({ kpis }: { kpis: ReadinessKpi[] }) {
  return (
...
function Tile({ kpi }: { kpi: ReadinessKpi }) {
