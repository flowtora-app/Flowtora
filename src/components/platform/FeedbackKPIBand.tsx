...
// 5-tile KPI band at the top of the feedback hub.
//
//   Total   New (7d)    Most-voted     Shipped (30d)   Avg rating
//   148     12 (+3)     "Bulk update"  4               4.3 ★
...
export interface FeedbackKpi {
  ...
  deltaPct?: number;
  /** Inverts the green/red mapping — increases in something bad become red. */
  deltaInvert?: boolean;
  tone?: "default" | "accent" | "success" | "warning" | "danger";
}

const TONE: Record<NonNullable<FeedbackKpi["tone"]>, { bg: string; border: string; label: string }> = {
...
export function FeedbackKPIBand({ kpis }: { kpis: FeedbackKpi[] }) {
  return (
...
function Tile({ kpi }: { kpi: FeedbackKpi }) {
