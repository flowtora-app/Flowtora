  ...
  return (
    <div className="space-y-5">
      ...
      <DeferredNote>
        ...
        under <span className="font-mono">PricingFormulaVersion.snapshot</span>. The diff +
        rollback UI ships when the JSON-diff component lands (same dependency the Plans
        changelog is waiting on).
      </DeferredNote>
    </div>
  );
}
