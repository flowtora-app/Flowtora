// Shared bits for the Pricing Formulas pages.
...
export const CATEGORY_LABEL: Record<PricingFormulaCategory, string> = {
  SQ_FT: "Sq ft / area",
  PER_PIECE: "Per piece",
  TIERED_QTY: "Tiered quantity",
  SETUP_RUN: "Setup + run",
  INSTALL_HOURLY: "Install hourly",
  BUNDLE: "Bundle",
  CUSTOM: "Custom",
};

export const STATUS_LABEL: Record<PricingFormulaStatus, string> = {
  DRAFT: "Draft",
  PUBLISHED: "Published",
  ARCHIVED: "Archived",
};
...
export function StatusPill({ status }: { status: PricingFormulaStatus }) {
  const palette =
