// Page 47 — shared bits for the Developer Documentation admin.

import * as React from "react";
import { STATUS_TONE, SECTION_LABELS, SECTION_ICONS } from "@/server/platform/developer-docs";
import type { DocPageStatus, DocSectionKey } from "@prisma/client";
...
export function StatusPill({ status }: { status: DocPageStatus }) {
...
export function SectionLabel({ section }: { section: DocSectionKey }) {
  return (
