// Shared bits for the Job Queue Monitor.
...
export const STATUS_COLOR: Record<OrderStatus, { bg: string; fg: string }> = {
  NEW:             { bg: "var(--surface-2)",       fg: "var(--text-muted)" },
  IN_PRODUCTION:   { bg: "var(--accent-surface)",  fg: "var(--accent-primary)" },
  READY:           { bg: "var(--success-surface)", fg: "var(--success-fg)" },
  OUT_FOR_INSTALL: { bg: "var(--warning-surface)", fg: "var(--warning-fg)" },
  COMPLETED:       { bg: "var(--success-surface)", fg: "var(--success-fg)" },
  CANCELED:        { bg: "var(--surface-2)",       fg: "var(--text-faint)" },
};
