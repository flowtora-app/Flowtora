...
export default async function NewPurchaseOrderPage({
  ...
  const action = createPurchaseOrder.bind(null, slug);
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      >
        <div className="flex items-start gap-3.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            >
              Start a draft PO. You&apos;ll add line items + receive against it from the PO detail page once it&apos;s created.
            </p>
          </div>
        </div>
      </header>
      ...
      {vendors.length === 0 ? (
        ...
        >
          You don&apos;t have any active vendors yet — add one first.{" "}
          <Link
        ...
        <Card>
          <form action={action} className="space-y-4 px-5 py-5">
            <label>
              ...
              <select name="supplierVendorId" required defaultValue="" style={inputStyle}>
            ...
            <label>
              ...
              <input type="date" name="expectedAt" style={inputStyle} />
            </label>
            <label>
              ...
              <textarea
                name="notes"
                rows={3}
                placeholder="Optional — shipping instructions, account number reference, etc."
                style={{
                  ...inputStyle,
                  height: "auto",
                  paddingTop: 10,
